...
startup {
	...
	vars.afterWarshipBuggyCutscene = 37;
...
start {
	if (vars.gamestateInfo.Old == vars.GameState_EndlessGeneration__mdToken && vars.gamestateInfo.Current == vars.GameState_Playing__mdToken) {
		...
		return vars.gamestateInfo.Current == vars.GameState_Playing__mdToken && vars.levelInfo.Current == vars.firstLevel;
	}
}
...
split {
	...
	if (vars.levelInfo.Current == vars.afterWarshipBuggyCutscene
			&& vars.levelInfo.Old == vars.unknownLevel) {
